    ...
    public static class GetApprovalStatus
    {
                                                        ...
                                                        ILogger log)
        {
            try
            {
                ...
                log.LogInformation($"Getting worfklow status for applicant Id: {applicantId}");
                ...
                {
                    return new HttpResponseMessage(HttpStatusCode.BadRequest) { Content = new StringContent("ApplicantId was not found") };
                }
