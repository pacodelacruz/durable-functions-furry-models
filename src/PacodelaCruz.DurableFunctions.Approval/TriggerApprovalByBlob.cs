...
namespace PacodelaCruz.DurableFunctions.Approval
{
    public static class TriggerApprovalByBlob
    {
            ...
            ILogger log)
        {
            ...
            // If the blob name containes the '_-_' substring, it identifies the first part of the blob name as the applicant and the remaining as the application name. Otherwise, the applicant is unknown and the application name is the full blobname. 
            ...
            log.LogInformation($"Durable Function Ochestration started applicant '{applicantId}' and application '{applicationName}'. InstanceId: {instanceId}");
        }
    }
}
