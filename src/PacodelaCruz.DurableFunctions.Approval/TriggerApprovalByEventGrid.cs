...
namespace PacodelaCruz.DurableFunctions.Approval
{
    public static class TriggerApprovalByEventGrid
    {
            ...
            ILogger log)
        {
            ...
            log.LogInformation($"Event Grid trigger function Processed blob\n Name: '{blobName}'");
            ...
            log.LogInformation($"Content Lenght '{contentLenght.ToString()}'");
            ...
            {
                log.LogError($"Event Grid Event has been discarded. Blob content lenght: {contentLenght}");
            }
        }
    }
}